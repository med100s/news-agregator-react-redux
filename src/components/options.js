...
export default function Options() {
    ...
    store.subscribe(() => {
        let counter = document.getElementsByClassName('fontSize')[0]
        let newsCounter = document.getElementsByClassName('newsPerPage')[0]
    ...
    return (
        <div>
            ...
            <p><button onClick={() => console.log(store.getState())}>GETSTATE</button></p>
